        ...
        <Modal
            ...
            <View style={styles.container}>
                <View style={styles.modal}>
                    ...
                    <Text medium center style={{color:Colors.Olive}}>Shared</Text>
                    <Button light bold color={Colors.Navy} buttonStyles={styles.closeButton} onPress={()=>props.onCancel()}>Close</Button>
                </View>
            </View>
        </Modal>
    );
