        ...
        <View {...this.panResponder.panHandlers} style={{ flex: 1 }}>
          ...
          <ScrollView contentContainerStyle={Styles.scrollView}>
            ...
            <View style={Styles.saveView}>
              ...
              <Text bold center style={{ marginVertical: 8 }}>
                Palliative Care Australia respects the privacy of all app users
                and will not make any attempt to identify you.
              </Text>
              <View
                style={{
                  flexDirection: "row",
          ...
          {draggingItem && (
            ...
            >
              ...
              >
                Drag and drop the card into your priority group, or simply
                release to cancel
              </Text>
              <Animated.View
                style={[
              ...
              >
                ...
                <Text style={Styles.question}>
                  {this.state.draggingItem.question}
                </Text>
                {draggingItem.selectedLevel != 0 && (
                  <ImageButton
                    source={Images.levelNotBlue}
                    style={Styles.itemLevelIcon}
                    onPress={this.onSelectedLevel.bind(
                      this,
                      draggingItem.cardIndex,
                      0
                    )}
                  />
                )}
