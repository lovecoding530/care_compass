    ...
    renderCardItem({item, index}){
        ...
        var cardItem = 
            <View style={Styles.cardItemWithStar}>
                ...
                <TouchableOpacity ref={ref=>itemEl=ref} style={Styles.cardItem} onLongPress={(e)=>{
                    ...
                    {(item.selectedLevel != 0) &&
                        <ImageButton source={Images.levelNotBlue} style={Styles.itemLevelIcon} onPress={this.onSelectedLevel.bind(this, item.cardIndex, 0)}/>
                    }
                    {(item.selectedLevel != 1) &&
                        <ImageButton source={Images.levelSomewhatBlue} style={Styles.itemLevelIcon} onPress={this.onSelectedLevel.bind(this, item.cardIndex, 1)}/>
                    }
                    {(item.selectedLevel != 2) &&
                        <ImageButton source={Images.levelVeryBlue} style={Styles.itemLevelIcon} onPress={this.onSelectedLevel.bind(this, item.cardIndex, 2)}/>
                    }
                </TouchableOpacity>
            </View>
        return cardItem
            ...
            <ImageBackground source={Images.bg_navigation} style={Styles.container}>
                ...
                >
                        ...
                        <Card style={Styles.levelContainer} contentStyle={{padding: 0}}>
                            <View style={[Styles.importantBar, Styles.veryImportantTitle]}>
                                ...
                                <View style={{flexDirection: 'row', alignItems: 'center', flex: 1}}>
                                    <View style={{flex: 1}}/>
                                    <Text light style={{fontStyle: 'italic'}}>Choose your top 3 priorities with a </Text>
                    ...
                    <View style={Styles.buttonBar}>
                        ...
                        <Button light bold onPress={this.onAddYourOwn}>Add your owns</Button>
                        <View style={{flex: 1}}/>
                    </View>
                    {draggingItem &&
                        <View style={{backgroundColor: '#fffe', position: 'absolute', top: 0, right: 0, bottom: 0, left: 0}}>
                            ...
                            <Animated.View style={[panStyle, Styles.draggingItem, {
                                ...
                                {(draggingItem.selectedLevel != 0) &&
                                    <ImageButton source={Images.levelNotBlue} style={Styles.itemLevelIcon} onPress={this.onSelectedLevel.bind(this, draggingItem.cardIndex, 0)}/>
                                }
                                {(draggingItem.selectedLevel != 1) &&
                                    <ImageButton source={Images.levelSomewhatBlue} style={Styles.itemLevelIcon} onPress={this.onSelectedLevel.bind(this, draggingItem.cardIndex, 1)}/>
                                }
                                {(draggingItem.selectedLevel != 2) &&
                                    <ImageButton source={Images.levelVeryBlue} style={Styles.itemLevelIcon} onPress={this.onSelectedLevel.bind(this, draggingItem.cardIndex, 2)}/>
                                }
                            </Animated.View>
