            ...
            <ImageBackground source={Images.bg_navigation} style={Styles.background}>
                <ScrollView style={Styles.container}>
                    <Card topbar style={Styles.titleView}>
                        ...
                        <View style={Styles.progress}>
                            <Text small bold center color={Colors.Olive}>{startNo} - {endNo} of {this.state.cardGame.cards.length}  </Text>
                            <ProgressBar total={this.state.pageTotalCount} progress={this.state.pageIndex + 1} style={Styles.progressBar}/>
                        </View>
                    </Card>
                    <FlatList
                ...
                <View style={Styles.buttonBar}>
                    ...
                    {this.state.pageIndex > 0 &&
                        <Button dark bold onPress={this.onPrev}>Prev</Button>
                    }
                    {this.state.pageIndex < this.state.pageTotalCount - 1 &&
                        <Button dark bold onPress={this.onNext}>Next</Button>    
                    }
                    {this.state.pageIndex == this.state.pageTotalCount - 1 &&
