        ...
        <Modal
            ...
            <View style={styles.container}>
                <View style={styles.modal}>
                    ...
                    <Text medium center color={Colors.Olive}>Perference added</Text>
                    <Text center style={{marginTop: 8,}}>Would you like to add another?</Text>
                    <View style={styles.buttons}>
                        <Button light bold color={Colors.Navy} buttonStyles={styles.closeButton} onPress={()=>onAddAnother()}>Add</Button>
                        <Button dark bold color={Colors.Navy} buttonStyles={styles.closeButton} onPress={()=>onFinish()}>Finish</Button>
                    </View>
                </View>
            </View>
        </Modal>
...
export default class AddYourOwn extends Component {
    ...
    onSelectedLevel(level){
        ...
        const {navigate, goBack, state: {params: {cardGame}}} = this.props.navigation
    ...
    onFinish = () => {
        const {navigate, goBack, state: {params: {cardGame, onGoBack}}} = this.props.navigation;
            ...
            <ImageBackground source={Images.bg_navigation} style={Styles.background}>
                <ScrollView contentContainerStyle={Styles.container}>
                    <Card topbar style={Styles.titleView}>
                        <Text mediumLarge center color={Colors.Red} style={Styles.title}>Your end-of-life preferences</Text>
                    </Card>
                    <Card style={Styles.cardView}>
                        <Text bold center color={Colors.Olive} style={Styles.howImportant}>Add your own...</Text>
                        <Text bold center>Enter your own end-of-life preference below, then use the buttons undermeath to choose it's importance</Text>
                        <TextInput
                            style={Styles.textArea}
                            value={this.state.yourOwn}
                            multiline={true}
                            onChangeText={(text) => {this.setState({yourOwn: text})}}
                        />
                    </Card>
                    <View style={Styles.levelBar}>
                        <TouchableOpacity style={{flex: 1}} onPress={this.onSelectedLevel.bind(this, 0)}>
                            <View style={Styles.levelItem}>
                                ...
                                <Text bold color={Colors.Navy}>Not</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={{flex: 1}} onPress={this.onSelectedLevel.bind(this, 1)}>
                            <View style={Styles.levelItem}>
                                ...
                                <Text bold color={Colors.Navy}>Somewhat</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={{flex: 1}} onPress={this.onSelectedLevel.bind(this, 2)}>
                            <View style={Styles.levelItem}>
                                ...
                                <Text bold color={Colors.Navy}>Very</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
                <View style={Styles.buttonBar}>
                    <Button light bold onPress={()=>goBack()}>Go back</Button>
                    <View style={{flex: 1}}/>
                    <Button dark bold onPress={()=>onFinish()}>Finish cards</Button>
                </View>
                <AddedModal
