    ...
    return (
      <View pointerEvents="box-none"  style={[styles.buttonWrapper, styles.fullScreen]}>
        {lastScreen
          ...
          : <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
          <Button text="Previous" onPress={() => this.swipePrev()} />
          <Button text="Next    " onPress={() => this.swipe()} /></View>
        }
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  pagination: {
    position: 'absolute',
    bottom: model=='iPad Mini' ? responsiveHeight(32):responsiveHeight(17),
    left: 0,
    right: 0,
    flex: 1,
    flexDirection: 'row',
  ...
  buttonWrapper: {
    ...
    position: 'absolute',
    bottom: model=='iPad Mini' ? responsiveHeight(30):responsiveHeight(15),
    left: 0,
    flex: 1,
